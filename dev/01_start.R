...
golem::fill_desc(
  ...
  pkg_title = "Shiny R package faithful geyser", # The Title of the package containing the App
  pkg_description = "Faithful histogram for Shiny4 workshop.", # The Description of the package containing the App
